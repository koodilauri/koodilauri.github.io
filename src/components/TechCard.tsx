...
function TechCardEl(props: IProps) {
  ...
  return (
    <Container
      className="px-2 py-1 text-xl rounded bg-purple-900 hover:bg-purple-700 flex flex-row transition delay-150 duration-150 ease-in-out transform hover:scale-105"
      key={code.id}
    >
